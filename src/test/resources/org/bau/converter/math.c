...
i8_array* org_bau_Std_convertFloatToI8Array_1(double n) {
    ...
    int64_t _t2 = int_1(n);
    i8_array* aa = org_bau_Std_convertIntToI8Array_1(_t2);
    int64_t _t3 = int_1(n);
    int64_t b = int_1(((n - _t3) * 1000000000000000000) + 1000000000000000000);
    while (1 == 1) {
        int64_t _t4 = b >= 100;
        if (_t4) {
            int64_t _t5 = ( imod_2(b, 10) ) == 0;
            _t4 = _t5;
        }
        if (!(_t4)) {
            break;
