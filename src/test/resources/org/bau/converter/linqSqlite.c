...
void org_bau_List_List_Customer_add_2(org_bau_List_List_Customer* this, Customer* x) {
    if (this->size >= _arrayLen(this->array)) {
        Customer_array* _t0 = Customer_array_new(_arrayLen(this->array) * 2);
        _incUseStack(_t0);
        Customer_array* n = _t0;
...
org_bau_db_Sqlite3_Record* org_bau_db_Sqlite3_Record_0() {
    org_bau_db_Sqlite3_Record* _t0 = org_bau_db_Sqlite3_Record_new();
    _t0->data = i8_array_new(0);
    return _t0;
}
org_bau_db_Sqlite3_Sqlite* org_bau_db_Sqlite3_Sqlite_0() {
...
org_bau_db_Sqlite3_text org_bau_db_Sqlite3_text_0() {
    org_bau_db_Sqlite3_text _t0 = org_bau_db_Sqlite3_text_new();
    _t0.data = i8_array_new(0);
    return _t0;
}
org_bau_List_List_Customer* org_bau_db_Sqlite3_Query_Customer_select_1(org_bau_db_Sqlite3_Query_Customer* this) {
    ...
    i8_array* _t0 = org_bau_db_Sqlite3_convertTextToI8Array_1(this->tableName);
    org_bau_String_StringBuilder_append_2(buff, _t0);
    ...
    org_bau_String_string _t1 = org_bau_String_StringBuilder_toString_1(buff);
    _incUseStack(_t1.data);
    i8_array* sql = _t1.data;
    ...
    if (this->db != NULL) {
        ...
        int64_t _t2 = org_bau_db_Sqlite3_Sqlite_prepare_2(this->db, sql);
        ;
        int64_t cols = 2;
        while (1 == 1) {
            int64_t _t3 = org_bau_db_Sqlite3_Sqlite_nextRow_1(this->db);
            if (!(_t3)) {
                break;
            }
            Customer* _t4 = NULL;
            ...
            while (c < 2) {
                if (this->db) {
                    ...
                    i8_array* _t5 = org_bau_db_Sqlite3_Sqlite_getString_2(this->db, c);
                    _incUseStack(_t5);
