...
void _main() {
    ...
    int64_t _t1000 = org_bau_DateTime_getNanoTime_0();
    org_bau_Utils_setRandomSeed_1(_t1000);
    int64_t _t1001 = org_bau_Utils_random_0();
    printf("%lld\n", (long long)_t1001);
    printf("%.9f\n", 3.141592653589793);
    while (1 == 1) {
        int64_t i = 2;
        while (i < 4) {
            double _t1002 = org_bau_Math_sqrt_1(i);
            printf("%.9f\n", _t1002);
            i = i + 1;
        }
        break;
